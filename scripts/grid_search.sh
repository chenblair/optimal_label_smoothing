...
do
    ...
    do
        ...
        python3 main.py --result_dir results/grid_search/$1/$2 --gpu 1 --method $2 --dataset $1 --noise_rate $noise_rate --smoothing $p --lr 0.01 --batch_size 128 --noise_type symmetric --n_epoch 100 --lambda_type nll $ARGS > /dev/null || break 2 &
    done
done
