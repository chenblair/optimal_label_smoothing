...
do
    ...
    do
        python3 main.py --result_dir results/grid_search --dataset mnist --noise_rate $noise_rate --smoothing $p --lr 0.1 --batch_size 128 --noise_type symmetric --n_epoch 100 --lambda_type nll || break 2
    done
done
